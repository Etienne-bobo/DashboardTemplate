<template>
    <div class="sticky top-0 z-40">
            <div class="w-full h-16 lg:px-24 px-6 bg-white pb-1 border-b flex items-center justify-between">

              <!-- left navbar -->
              <div class="flex">

                <!-- mobile hamburger -->
                <div class="inline-block lg:hidden items-center mr-4 pt-5">
                ...
                <div class="relative text-gray-600">
                  <input type="search" name="search" placeholder="Search jobs..." class="bg-white h-16 w-full px-5  text-sm focus:outline-none">
                  <button type="submit" class="absolute left-0 top-0 mt-6 mr-4">
